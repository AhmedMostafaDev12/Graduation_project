...
try:
    from sentry_app.services.burn_out_service.Analysis_engine_layer import (
        WorkloadAnalyzer,
        UserMetrics,
        SentimentAnalyzer,
        QualitativeData,
...
class BurnoutSystemIntegration:
    ...
    def analyze_user_burnout(
        ...
        if qualitative_data and qualitative_data.has_data():
            ...
            from sentry_app.services.burn_out_service.Analysis_engine_layer.sentiment_analyzer import SentimentAnalysisResult, BurnoutSignals
        ...
        if not user_profile:
            ...
            from sentry_app.services.burn_out_service.user_profile.user_profile_models import UserProfile
