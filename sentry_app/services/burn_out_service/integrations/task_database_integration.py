...
try:
    from sentry_app.services.burn_out_service.Analysis_engine_layer import UserMetrics
except ImportError:
...
def get_complete_user_context(
    ...
    from sentry_app.services.burn_out_service.Analysis_engine_layer.sentiment_analyzer import QualitativeData
